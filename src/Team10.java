...
public class Team10 {
    ...
    static final String NICKNAME = "서울10반_이지민_조민재";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (socket != null) {
                ...
                float targetBall_x = targets[0][0] + (float) Math.random();
                float targetBall_y = targets[0][1] - (float) Math.random();
